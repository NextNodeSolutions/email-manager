...
export type QueueBackendConfig =
	...
	| {
			backend: 'sqlite'
			/**
			 * Application namespace to prevent conflicts between apps.
			 * Creates a subdirectory in the system data directory.
			 *
			 * @example 'my-saas-app' → ~/.local/share/email-manager/my-saas-app/
			 */
			appName: string
			/**
			 * Database identifier for multi-queue support within the same app.
			 *
			 * @example 'notifications' → ~/.local/share/email-manager/{appName}/notifications.db
			 * @default 'queue'
			 */
			databaseKey?: string
